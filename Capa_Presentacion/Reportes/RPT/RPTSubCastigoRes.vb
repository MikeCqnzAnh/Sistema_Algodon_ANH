...
Public Class RPTSubCastigoRes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTSubCastigoRes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTSubCastigoRes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTSubCastigoRes = New RPTSubCastigoRes()
        rpt.Site = Me.Site
        Return rpt
    End Function
