...
Public Class RPTDetallecompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTDetallecompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDetallecompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDetallecompra = New RPTDetallecompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
