...
Public Class RPTReporteClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTReporteClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTReporteClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTReporteClientes = New RPTReporteClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
