...
Public Class RPTSubCastigoUni
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTSubCastigoUni.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTSubCastigoUni
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTSubCastigoUni = New RPTSubCastigoUni()
        rpt.Site = Me.Site
        Return rpt
    End Function
