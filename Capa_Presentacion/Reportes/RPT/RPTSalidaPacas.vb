...
Public Class RPTSalidaPacas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTSalidaPacas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTSalidaPacas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTSalidaPacas = New RPTSalidaPacas()
        rpt.Site = Me.Site
        Return rpt
    End Function
