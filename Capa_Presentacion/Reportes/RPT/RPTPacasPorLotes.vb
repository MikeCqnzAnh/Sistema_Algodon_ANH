...
Public Class RPTPacasPorLotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTPacasPorLotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPacasPorLotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPacasPorLotes = New RPTPacasPorLotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
