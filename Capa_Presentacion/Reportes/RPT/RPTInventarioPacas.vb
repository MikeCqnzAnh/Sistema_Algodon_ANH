...
Public Class RPTInventarioPacas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTInventarioPacas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTInventarioPacas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTInventarioPacas = New RPTInventarioPacas()
        rpt.Site = Me.Site
        Return rpt
    End Function
