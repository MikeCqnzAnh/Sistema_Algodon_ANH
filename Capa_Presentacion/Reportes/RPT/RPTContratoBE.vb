...
Public Class RPTContratoBE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTContratoBE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTContratoBE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTContratoBE = New RPTContratoBE()
        rpt.Site = Me.Site
        Return rpt
    End Function
