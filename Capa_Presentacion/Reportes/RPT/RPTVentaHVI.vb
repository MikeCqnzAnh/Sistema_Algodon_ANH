...
Public Class RPTVentaHVI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTVentaHVI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTVentaHVI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTVentaHVI = New RPTVentaHVI()
        rpt.Site = Me.Site
        Return rpt
    End Function
