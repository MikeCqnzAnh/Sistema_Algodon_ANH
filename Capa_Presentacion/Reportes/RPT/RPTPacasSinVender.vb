...
Public Class RPTPacasSinVender
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTPacasSinVender.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPacasSinVender
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPacasSinVender = New RPTPacasSinVender()
        rpt.Site = Me.Site
        Return rpt
    End Function
