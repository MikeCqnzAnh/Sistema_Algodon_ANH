...
Public Class RPTPacasFaltantes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTPacasFaltantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPacasFaltantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPacasFaltantes = New RPTPacasFaltantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
