...
Public Class RPTPaquetesVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTPaquetesVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPaquetesVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPaquetesVenta = New RPTPaquetesVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
