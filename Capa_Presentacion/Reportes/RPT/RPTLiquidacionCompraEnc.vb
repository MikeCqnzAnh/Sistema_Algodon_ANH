...
Public Class RPTLiquidacionCompraEnc
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPTLiquidacionCompraEnc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTLiquidacionCompraEnc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTLiquidacionCompraEnc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTLiquidacionCompraEnc = New RPTLiquidacionCompraEnc()
        rpt.Site = Me.Site
        Return rpt
    End Function
