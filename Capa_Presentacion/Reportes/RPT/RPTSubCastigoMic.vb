...
Public Class RPTSubCastigoMic
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTSubCastigoMic.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTSubCastigoMic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTSubCastigoMic = New RPTSubCastigoMic()
        rpt.Site = Me.Site
        Return rpt
    End Function
