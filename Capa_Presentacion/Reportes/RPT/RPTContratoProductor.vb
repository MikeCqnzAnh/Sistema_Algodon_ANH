...
Public Class RPTContratoProductor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPTContratoProductor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTContratoProductor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTContratoProductor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTContratoProductor = New RPTContratoProductor()
        rpt.Site = Me.Site
        Return rpt
    End Function
