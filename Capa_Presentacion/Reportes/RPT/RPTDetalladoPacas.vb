...
Public Class RPTDetalladoPacas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTDetalladoPacas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTDetalladoPacas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTDetalladoPacas = New RPTDetalladoPacas()
        rpt.Site = Me.Site
        Return rpt
    End Function
