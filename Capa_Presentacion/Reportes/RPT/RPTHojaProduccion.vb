...
Public Class RPTHojaProduccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTHojaProduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTHojaProduccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTHojaProduccion = New RPTHojaProduccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
