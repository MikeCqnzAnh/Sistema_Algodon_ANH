...
Public Class RPTSubCastigoLar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTSubCastigoLar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTSubCastigoLar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTSubCastigoLar = New RPTSubCastigoLar()
        rpt.Site = Me.Site
        Return rpt
    End Function
