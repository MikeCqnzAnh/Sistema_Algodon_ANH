...
Public Class RPTOrdenEmbarque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTOrdenEmbarque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTOrdenEmbarque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTOrdenEmbarque = New RPTOrdenEmbarque()
        rpt.Site = Me.Site
        Return rpt
    End Function
