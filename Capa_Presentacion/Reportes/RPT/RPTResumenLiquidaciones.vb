...
Public Class RPTResumenLiquidaciones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPTResumenLiquidaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTResumenLiquidaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pCve_cpa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPTResumenLiquidaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTResumenLiquidaciones = New RPTResumenLiquidaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
