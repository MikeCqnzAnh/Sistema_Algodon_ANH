...
Public Class RPTColumnasEncabezado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPTColumnasEncabezado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTColumnasEncabezado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTColumnasEncabezado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTColumnasEncabezado = New RPTColumnasEncabezado()
        rpt.Site = Me.Site
        Return rpt
    End Function
