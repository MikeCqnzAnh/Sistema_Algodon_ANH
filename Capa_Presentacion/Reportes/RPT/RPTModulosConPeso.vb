...
Public Class RPTModulosConPeso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTModulosConPeso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTModulosConPeso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTModulosConPeso = New RPTModulosConPeso()
        rpt.Site = Me.Site
        Return rpt
    End Function
