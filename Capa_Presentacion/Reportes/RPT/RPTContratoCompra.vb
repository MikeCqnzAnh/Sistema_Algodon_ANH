...
Public Class RPTContratoCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTContratoCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTContratoCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTContratoCompra = New RPTContratoCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
