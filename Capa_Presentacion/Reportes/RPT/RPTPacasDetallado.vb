...
Public Class RPTPacasDetallado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Capa_Presentacion.RPTPacasDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTPacasDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTPacasDetallado = New RPTPacasDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
