...
Public Class RepConsultaPacasDetalleCompra
    ...
    Private Sub ExportaExcel()
        ...
        If Not Directory.Exists(System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\CalculaCotton Export PacaDetalle excel" & "\" & BaseDeDatos) Then
            Directory.CreateDirectory(System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\CalculaCotton Export PacaDetalle excel" & "\" & BaseDeDatos)
        End If
        Dim strFN As String = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\CalculaCotton Export PacaDetalle excel" & "\" & BaseDeDatos & "\Detalle_Paca_Compra" & Now.DayOfYear & Now.Month & ".xlsx"   'must have ".xlsx" extension
