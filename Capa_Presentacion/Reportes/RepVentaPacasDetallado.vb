...
Imports System.IO
Public Class RepVentaPacasDetallado
    ...
    Private Sub ConsultaReporte()
        ...
        Dim CrReport As RPTDetalleVenta = New RPTDetalleVenta
        Dim Ruta As String = Application.StartupPath & "\Reportes\RPT\RPTDetalleVenta.rpt"
        EntidadReportes.Reporte = Reporte.ReporteVentaPacasDetallado
        ...
        CRVReporteVentaDetalle.ReportSource = CrReport
        CRVReporteVentaDetalle.Show()
    End Sub
End Class