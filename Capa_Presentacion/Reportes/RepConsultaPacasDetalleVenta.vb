...
Public Class RepConsultaPacasDetalleVenta
    ...
    Private Sub ExportarExcel()
        ...
        End If
        Dim strFN As String = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\CalculaCotton Export PacaDetalle excel" & "\" & BaseDeDatos & "\Detalle_Paca_Venta" & Now.DayOfYear & Now.Month & ".xlsx"   'must have ".xlsx" extension
