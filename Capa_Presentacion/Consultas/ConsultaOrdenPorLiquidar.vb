...
Public Class ConsultaOrdenPorLiquidar
    ...
    Private Sub ConsultaOrdenPorLiquidar_Load(sender As Object, e As EventArgs) Handles Me.Load
        limpiar()
    ...
    Private Sub ConsultaOrdenTrabajo()
        ...
        Try
            ...
            EntidadLiquidacionesPorRomaneaje.Consulta = Consulta.ConsultaOrdenporliquidar
