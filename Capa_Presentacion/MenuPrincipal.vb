...
Public Class MenuPrincipal
    ...
    Private Sub Salir(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ...
        End If
    End Sub
    Private Sub controlmenu(ByVal scl As Boolean)
        CatálogosToolStripMenuItem.Enabled = scl
        ProcesosToolStripMenuItem.Enabled = scl
        ComercializaciónToolStripMenuItem.Enabled = scl
        AlmacenesToolStripMenuItem.Enabled = scl
        AdministraciónToolStripMenuItem.Enabled = scl
        ReportesToolStripMenuItem.Enabled = scl
        UtileriasToolStripMenuItem.Enabled = scl
    End Sub
    ...
    Private Async Function conexioninternet() As Task(Of Boolean)
        ...
        End Try
    End Function
    Private Function validar(licencia As Licencia) As String
        Dim mensaje As String = ""
    ...
    Private Sub PaquetesParaVentaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PaquetesParaVentaToolStripMenuItem.Click
        Dim _paqueteclasificacion As New VentaClasificacion
        _paqueteclasificacion.Show()
    End Sub
    ...
    Private Sub CompraDePacasPorContratoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CompraDePacasPorContratoToolStripMenuItem.Click
        Dim compracontrato As New CompraPacasPorContrato()
