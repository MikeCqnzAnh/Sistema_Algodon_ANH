...
Public Class VentaClasificacion
    ...
    Private Sub propiedadesDgv()
        ...
        If DgvPacasClasificacion.Columns("BaleId") Is Nothing Then
            ...
            Dim colLibras As New DataGridViewTextBoxColumn
            colLibras.Name = "Libras"
            colLibras.HeaderText = "Libras"
            colLibras.Visible = False
            DgvPacasClasificacion.Columns.Insert(4, colLibras)

            Dim colQuintales As New DataGridViewTextBoxColumn
            colQuintales.Name = "Quintales"
            colQuintales.HeaderText = "Quintales"
            colQuintales.Visible = False
            DgvPacasClasificacion.Columns.Insert(5, colQuintales)

            Dim colLotID As New DataGridViewTextBoxColumn
            colLotID.Name = "LotID"
            colLotID.HeaderText = "LotID"
            colLotID.ReadOnly = True
            DgvPacasClasificacion.Columns.Insert(6, colLotID)

            Dim colBaleID As New DataGridViewTextBoxColumn
            colBaleID.Name = "BaleID"
            colBaleID.HeaderText = "No Paca"
            colBaleID.ReadOnly = True
            DgvPacasClasificacion.Columns.Insert(7, colBaleID)
            ...
            DgvPacasClasificacion.Columns.Insert(11, colTemperature)
            ...
            DgvPacasClasificacion.Columns.Insert(16, colStrength)
            ...
            DgvPacasClasificacion.Columns.Insert(17, colElongation)

            Dim colSFI As New DataGridViewTextBoxColumn
            colSFI.Name = "SFI"
            'colSFI.HeaderText = "No Paca"
            colSFI.Visible = False
            DgvPacasClasificacion.Columns.Insert(18, colSFI)
            ...
            DgvPacasClasificacion.Columns.Insert(19, colMaturity)
            ...
            colRd.Visible = True
            colRd.ReadOnly = True
            DgvPacasClasificacion.Columns.Insert(23, colRd)
            ...
            DgvPacasClasificacion.Columns.Insert(24, colPlusb)
            ...
            DgvPacasClasificacion.Columns.Insert(25, colColorGrade)
            ...
            DgvPacasClasificacion.Columns.Insert(26, colTrashCount)
            ...
            DgvPacasClasificacion.Columns.Insert(27, colTrashArea)
            ...
            DgvPacasClasificacion.Columns.Insert(32, colFlagTerminado)
            ...
            DgvPacasClasificacion.Columns.Insert(33, colEstatusCompra)
            ...
            DgvPacasClasificacion.Columns.Insert(34, colIdVenta)
    ...
    Private Sub CreaTabla()
        ...
        TablaClasificacionGrid.Columns.Add(New DataColumn("Libras", System.Type.GetType("System.Double")))
        TablaClasificacionGrid.Columns.Add(New DataColumn("Quintales", System.Type.GetType("System.Double")))
    ...
    Private Sub DataGridViewToTable()
        ...
        For Each row As DataGridViewRow In DgvPacasClasificacion.Rows
            ...
            rengloninsertar("Libras") = DgvPacasClasificacion.Rows(index).Cells("Libras").Value
            rengloninsertar("Quintales") = DgvPacasClasificacion.Rows(index).Cells("Quintales").Value
    ...
    Private Sub IgualarClasificacion()
        ...
        If TablaClasificacionGlobal.Rows.Count > 0 Then
            For Each Fila As DataRow In TablaClasificacionGlobal.Rows
                ...
                NegocioClasificacionVentaPaquetes.Consultar(EntidadClasificacionVentaPaquetes)
                Tabla = EntidadClasificacionVentaPaquetes.TablaConsulta
                DgvPacasClasificacion.Rows.Add(0, Tabla.Rows(0).Item("IdOrdenTrabajo"), Tabla.Rows(0).Item("IdPlantaOrigen"), Tabla.Rows(0).Item("Kilos"), Tabla.Rows(0).Item("Libras"), Tabla.Rows(0).Item("Quintales"), Tabla.Rows(0).Item("LotID"), Tabla.Rows(0).Item("BaleID"), Tabla.Rows(0).Item("BaleGroup"), Tabla.Rows(0).Item("Operator"), Tabla.Rows(0).Item("Date"), Tabla.Rows(0).Item("Temperature"), Tabla.Rows(0).Item("Humidity"), Tabla.Rows(0).Item("Amount"), Tabla.Rows(0).Item("UHML"), Tabla.Rows(0).Item("UI"), Tabla.Rows(0).Item("Strength"), Tabla.Rows(0).Item("Elongation"), Tabla.Rows(0).Item("SFI"), Tabla.Rows(0).Item("Maturity"), Tabla.Rows(0).Item("Grade"), Tabla.Rows(0).Item("Moist"), Tabla.Rows(0).Item("Mic"), Tabla.Rows(0).Item("Rd"), Tabla.Rows(0).Item("Plusb"), Tabla.Rows(0).Item("ColorGrade"), Tabla.Rows(0).Item("TrashCount"), Tabla.Rows(0).Item("TrashArea"), Tabla.Rows(0).Item("TrashID"), Tabla.Rows(0).Item("SCI"), Tabla.Rows(0).Item("Nep"), Tabla.Rows(0).Item("UV"), Tabla.Rows(0).Item("FlagTerminado"))
            Next
        End If
        TablaClasificacionGlobal.Clear()
        DgvPacasClasificacion.Sort(DgvPacasClasificacion.Columns("BaleID"), System.ComponentModel.ListSortDirection.Descending)
