...
Public Class CompraPacasContrato
    ...
    Private Function DataGridADatatable(ByVal EstatusCompraUpdate As Integer, ByVal EstatusCompraBusqueda As Integer, ByVal DataGridEnvia As DataGridView, ByVal IdCompraEnc As Integer, Optional valcastigo As Integer = 0) As DataTable
        ...
        Try
            ...
            dt.Columns.Add("Libras", Type.GetType("System.Single"))
            ...
            For i = 0 To DataGridEnvia.Rows.Count - 1
                ...
                If DataGridEnvia.Item("Seleccionar", i).EditedFormattedValue = True Then
                    ...
                    r("Libras") = DataGridEnvia.Item("Libras", i).Value
    ...
    Private Sub ConsultarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultarToolStripMenuItem.Click
        ...
        If _ConsultaCompraProductor.idcompra_ > 0 Then
            TbIdCompraPaca.Text = _ConsultaCompraProductor.idcompra_
            TbIdProductor.Text = _ConsultaCompraProductor.idproductor_
            TbNombreProductor.Text = _ConsultaCompraProductor.nombreproductor_
    ...
    Private Sub PropiedadesDgvPacasComprar()
        ...
        DgvPacasComprar.Columns("Libras").Visible = False
    ...
    Private Sub PropiedadesDgvPacasIndCompradas()
        ...
        DgvPacasIndCompradas.Columns("Libras").Visible = False
    ...
    Private Sub LiquidacionDeCompraToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LiquidacionDeCompraToolStripMenuItem.Click
    ...
    Private Sub BtBuscarProductor_Click(sender As Object, e As EventArgs) Handles BtBuscarProductor.Click
        ...
        If _ConsultaProductorContratoCompras.idproductor_ > 0 Then
            Nuevo()
            TbIdProductor.Text = _ConsultaProductorContratoCompras.idproductor_
            TbNombreProductor.Text = _ConsultaProductorContratoCompras.nombre_
            ConsultarDatosCompra()
            gbcontratos.Enabled = True
        End If
    End Sub
