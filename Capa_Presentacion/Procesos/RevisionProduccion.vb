...
Public Class RevisionProduccion
            ...
            If opc = DialogResult.Yes Then
                Try
                    For i As Integer = 0 To DgvPacas.Rows.Count() - 1
                        ...
                        If c = True Then
                            GeneraRegistroBitacora(Me.Text.Clone.ToString, BtEliminarPacas.Text, DgvPacas.Rows(i).Cells("BaleID").Value, DgvPacas.Rows(i).Cells("Kilos").Value & " KGs DEL PRODUCTOR " & TbNombreProductor.Text & " CON LA ORDEN No " & TbIdOrdenTrabajo.Text & " EN PLANTA " & CbPlanta.Text)
    ...
    Private Function ConsultarPacaExistente(ByVal BaleID As Long, ByVal IdPlantaElabora As Integer)
        ...
        'EntidadProduccion.BaleID = IIf(SpCapturaAutomatica.IsOpen = True, Val(TbFolioInicial.Text), Val(TbBaleID.Text))
