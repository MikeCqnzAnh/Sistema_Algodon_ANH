...
Public Class Respaldos
    ...
    Sub LeerArchivo()
        ...
        End Try
    End Sub
    Private Sub Respaldos_Load(sender As Object, e As EventArgs) Handles Me.Load
        lblDBName.Text = "..."
        lblDBSize.Text = "..."
    ...
    End Sub
    Private Sub txts_TextChanged(sender As Object, e As EventArgs) Handles TbServidor.TextChanged, TbBDD.TextChanged, TbUsuario.TextChanged, TbPassword.TextChanged
        ...
        If Not String.IsNullOrWhiteSpace(TbServidor.Text) And Not String.IsNullOrWhiteSpace(TbBDD.Text) And
                Not String.IsNullOrWhiteSpace(TbUsuario.Text) And Not String.IsNullOrWhiteSpace(TbPassword.Text) Then
    ...
    Private Sub txtBackupName_TextChanged(sender As Object, e As EventArgs) Handles TbBackupName.TextChanged
        If Not String.IsNullOrWhiteSpace(TbBackupName.Text) Then
