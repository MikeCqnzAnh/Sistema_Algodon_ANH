...
Public Class ContratosAlgodon
    Public Overridable Sub Upsert(ByRef EntidadContratosAlgodon As Capa_Entidad.ContratosAlgodon)
        ...
        Try
            cnn.Open()
            Select Case EntidadContratosAlgodon1.Guarda
                Case Configuracion.Guardar.GuardarEncabezado
                    ...
                    cmdGuardar.Parameters.Add(New SqlParameter("@idUnidadPeso", EntidadContratosAlgodon1.IdUnidadPeso))
                    cmdGuardar.Parameters.Add(New SqlParameter("@SuperficieComprometida", EntidadContratosAlgodon1.SuperficieComprometida))
                    'cmdGuardar.Parameters.Add(New SqlParameter("@Lotes", EntidadContratosAlgodon1.Lotes))
                    'cmdGuardar.Parameters.Add(New SqlParameter("@IdContratovta", EntidadContratosAlgodon1.IdContratoVta))
                    'cmdGuardar.Parameters.Add(New SqlParameter("@DescripcionVta", EntidadContratosAlgodon1.DescripcionVta))
        ...
        Try
            ...
            Select Case EntidadContratosAlgodon1.Consulta
                ...
                Case Capa_Operacion.Configuracion.Consulta.ConsultaContratovta
                    ...
                    sqlcom1.CommandType = CommandType.StoredProcedure
                    sqlcom1.Parameters.Clear()
                    sqlcom1.Parameters.Add(New SqlParameter("@nombre", EntidadContratosAlgodon1.NombreComprador))
                    sqldat1.Fill(EntidadContratosAlgodon1.TablaConsulta)
            End Select
        Catch ex As Exception
            cnn.Close()
