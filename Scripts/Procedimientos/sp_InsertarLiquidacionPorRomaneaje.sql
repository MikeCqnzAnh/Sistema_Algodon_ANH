...
UPDATE SET    IdOrdenTrabajo = source.IdOrdenTrabajo,
			  ...
			  TotalPluma= source.TotalPluma,
			  PorcentajePluma= source.PorcentajePluma,
			  PorcentajeSemilla= source.PorcentajeSemilla,
			  TotalSemilla= source.TotalSemilla,
			  PorcentajeMerma= source.PorcentajeMerma,
			  TotalMerma= source.TotalMerma,
			  TotalPacas= source.TotalPacas,
			  TotalBoletas= source.TotalBoletas,
			  TotalBorregos= source.TotalBorregos,
			  TotalPlumaBorregos= source.TotalPlumaBorregos,
		...
		WHEN NOT MATCHED THEN
          ...
          VALUES (source.IdOrdenTrabajo,
				  ...
				  source.TotalSemilla,
				  source.PorcentajeMerma,
				  source.TotalMerma,
				  source.TotalPacas,
				  source.TotalBoletas,
				  source.TotalBorregos,
				  source.TotalPlumaBorregos,
				  source.IdEstatus,
